...
public class ArticleEndpoint {
	...
	public Response createArticle(@Valid ArticleDTO articleDTO) {
		try {
			Long id = articleController.addArticle(articleDTO);
	...
	public Response updateArticle(@PathParam("articleId") Long articleId, @Valid ArticleDTO articleDTO) {
		try {
			articleController.updateArticle(articleId, articleDTO);
	...
	public Response getArticleInfo(@PathParam("articleId") Long articleId) {
		try {
			ArticleDTO articleDTO = articleController.getArticleInfoExtended(articleId);
	...
	public Response searchArticles(@QueryParam("isbn") String isbn, @QueryParam("issn") String issn,
		...
		try {
    		long totalResults = articleController.countArticles(isbn, issn, isan, title, genre, publisher, _yearEdition, author, issueNumber, director);
			...
			List<ArticleDTO> articleDTOs = articleController.searchArticles(isbn, issn, isan, title, genre,
    ...
    public Response deleteArticle(@PathParam("articleId") Long articleId) {
        try {
            articleController.removeArticle(articleId);
